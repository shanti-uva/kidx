...
.button {
    ...
    background-image: -webkit-gradient(linear, left bottom, left top, color-stop(0, #999999), color-stop(0.5, #DDDDDD));
    background-image: -moz-linear-gradient(center bottom, #999999 0%, #DDDDDD 50%);
}
...
.downloadbtn {
    ...
    background-image: -webkit-gradient(linear, left bottom, left top, color-stop(0, #000000), color-stop(0.5, #444444));
    background-image: -moz-linear-gradient(center bottom, #000000 0%, #444444 50%);
    color: white;
}
...
.runbtn {
    ...
    background-image: -webkit-gradient(linear, left bottom, left top, color-stop(0, #5DA966), color-stop(0.5, #DBF3C8));
    background-image: -moz-linear-gradient(center bottom, #5DA966 0%, #DBF3C8 50%);
}
...
<h1>Nimble</h1>
    <span class="download">
      ...
      <a href="https://github.com/caolan/nimble/raw/master/nimble.js">Development</a> | <a
            href="https://github.com/caolan/nimble/raw/master/nimble.min.js">Production</a>
      <span class="size">(829 bytes, minified and gzipped)</span>
    </span>
<a href="https://github.com/caolan/nimble"><img style="position: absolute; top: 0; right: 0; border: 0;"
...
<div class="section" id="intro">
    <p>
        ...
        Combines the most useful features of the <a href="http://documentcloud.github.com/underscore/">underscore</a>
        and
        <a href="https://github.com/caolan/async">async</a> libraries with a simple API and a vastly reduced filesize.
    </p>

    <p><a href="https://github.com/caolan/nimble">Nimble on GitHub</a> | <a href="http://twitter.com/caolan">Me on
        Twitter</a></p>
</div>
