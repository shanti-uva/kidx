...
// In the browser it's seamless; using node.js you have to do the extra mixin step.
    ...
    exports['each - sync, unsupported objects'] = function (test) {
        ...
        test.strictEqual(
            _.each(123, function (v) {
                return v;
            }),
            undefined
        );
        test.strictEqual(
            _.each('asdf', function (v) {
                return v;
            }),
            undefined
        );
    ...
    exports['map - sync, unsupported objects'] = function (test) {
        test.same(
            _.map(null, function (v) {
                return v;
            }),
            []
        );
        test.same(
            _.map(undefined, function (v) {
                return v;
            }),
            []
        );
        test.same(
            _.map(123, function (v) {
                return v;
            }),
            []
        );
    ...
    exports['filter - sync, unsupported objects'] = function (test) {
        test.same(
            _.filter(null, function (v) {
                return v;
            }),
            []
        );
        test.same(
            _.filter(undefined, function (v) {
                return v;
            }),
            []
        );
        test.same(
            _.filter(123, function (v) {
                return v;
            }),
            []
        );
        ...
        if ('asdf'[0]) {
            ...
            var r = _.filter('asdf', function (v) {
                return v;
            });
            test.same(r, []);
        }
    ...
    exports['reduce - sync, unsupported objects'] = function (test) {
        test.strictEqual(
            _.reduce(null, function (a, v) {
                return a + v;
            }, 'memo'),
            'memo'
        );
        test.strictEqual(
            _.reduce(undefined, function (a, v) {
                return a + v;
            }, 'memo'),
            'memo'
        );
        test.strictEqual(
            _.reduce(123, function (a, v) {
                return a + v;
            }, 'memo'),
            'memo'
        );
